...
// RunMigrations applies any unapplied SQL migration files from the provided fs.FS
// in filename order. Applied migrations are recorded in the schema_migrations table.
// The caller is responsible for embedding the migrations directory and passing it in.
