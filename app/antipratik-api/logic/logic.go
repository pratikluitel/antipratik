...
type PostLogic interface {
	...
	CreateMusic(ctx context.Context, preID string, input models.CreateMusicPost) (string, error)
	CreatePhoto(ctx context.Context, preID string, input models.CreatePhotoPost) (string, error)
	CreateVideo(ctx context.Context, preID string, input models.CreateVideoPost) (string, error)
	CreateLinkPost(ctx context.Context, preID string, input models.CreateLinkPost) (string, error)
